...
let
  ...
  themeName = "Tokyonight-${capitalize cfg.variant}";
  ...
  themeFile = iniFormat.generate "fcitx5-${config.nixporn.colorscheme.slug}-theme.conf" {
    ...
    InputPanel = {
      ...
      NormalColor = palette.base.fg;
      HighlightCandidateColor = palette.base.bg;
      HighlightColor = palette.base.blue;
      HighlightBackgroundColor = palette.base.bg_highlight;
      # Use catppuccin spacing
      Spacing = 3;
    };
    "InputPanel/Background" = {
      # Catppuccin style: flat design without rounded corners
      Color = palette.base.bg;
      BorderColor = palette.base.bg_highlight;
      BorderWidth = 0;
    };
    ...
    "InputPanel/Highlight" = {
      ...
      BorderColor = "${palette.base.blue}00";
      BorderWidth = 0;
    };
    ...
    "Menu/Background" = {
      # Catppuccin style: flat design without rounded corners
      Color = palette.base.bg;
      BorderColor = "${palette.base.bg_highlight}00";
      BorderWidth = 0;
    };
    ...
    "Menu/Separator" = {
      Color = palette.base.bg_highlight;
      BorderColor = "${palette.base.bg_highlight}00";
      BorderWidth = 0;
    };
  };
